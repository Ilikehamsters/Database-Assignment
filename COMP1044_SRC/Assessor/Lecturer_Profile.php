<?php require_once 'Get_Lecturer_Profile.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="infoContainer">
        ...
        <div class="form-grid">
            <div class="detail-group">
                <span class="detail-label">Lecturer ID</span>
                <div class="detail-value"><?= htmlspecialchars($profile['Staff_ID']) ?></div>
            </div>
            ...
            <div class="detail-group">
                ...
                <div class="detail-value"><?= htmlspecialchars($profile['Employ_Date']) ?></div>
            </div>
        </div>
